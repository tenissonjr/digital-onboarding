...
CREATE TABLE VALIDACAO_PRECADASTRO (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    PRECADASTRO_id BIGINT NOT NULL,
    campo VARCHAR(100) NOT NULL,
    mensagem VARCHAR(500) NOT NULL,
    data_registro TIMESTAMP NOT NULL,
    created_at TIMESTAMP NOT NULL,
    created_by VARCHAR(100),
    FOREIGN KEY (PRECADASTRO_id) REFERENCES PRECADASTRO(id)
);
CREATE INDEX idx_VALIDACAO_PRECADASTRO_PRECADASTRO_id ON VALIDACAO_PRECADASTRO(PRECADASTRO_id);
